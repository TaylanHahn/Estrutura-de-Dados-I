...
int main() {
	...
	// --- TODO (Melhorias 3, 4, 5): adicionar novas opções de menu ---
	// (descomente as linhas abaixo quando as funções estiverem prontas)
	// printf("5 - Buscar contato por CPF\n");
	// printf("6 - Buscar contato por Nome (parcial)\n");
	...
	scanf("%d", &escolha);
		...
		switch (escolha) {
			...
			// --- TODO (Melhorias 3, 4, 5): adicionar novos cases ---
			// (descomente os blocos abaixo quando as funções estiverem prontas)
			/*
			case 5:
		...
		// --- TODO (Melhorias 3, 4, 5): ATUALIZAR ESTE IF ---
		// (quando as novas opções 5, 6 e 7 forem implementadas,
		// elas não devem imprimir a lista inteira de novo)
		// (o 'escolha <= 4' deve ser mudado para 'escolha <= 7')
		// (e o 'escolha != 3' deve ser mudado para 'escolha != 3 && escolha != 5 && escolha != 6 ...')
