...
// --- MELHORIA 3: protótipo da função de busca por cpf ---
// (descomente a linha abaixo para implementar a funcionalidade)
// void buscarPorCPF(tLista *lista);
	// busca um contato pelo cpf exato e imprime na tela

// --- MELHORIA 4: protótipo da função de busca por nome ---
// (descomente a linha abaixo para implementar a funcionalidade)
// void buscarPorNome(tLista *lista);
	// busca contatos por parte do nome (busca parcial)
	// e imprime os que forem encontrados

// --- MELHORIA 5: protótipo da função de alterar contato ---
// (descomente a linha abaixo para implementar a funcionalidade)
// void alterarContato(tLista *lista);
	// primeiro busca um contato (pode ser por cpf ou nome)
	// e depois permite alterar (nome, email, telefone)
