...
int main() {
	...
	// --- MELHORIAS 3, 4 E 5: adicionar novas opções de menu ---
	// (descomente as linhas abaixo para implementar as funcionalidades)
	...
	scanf("%d", &escolha);
		...
		switch (escolha) {
			...
			// --- MELHORIA 3: adicionar novo case ---
			...
			*/
			...
			// --- MELHORIA 4: adicionar novo case ---
			// (descomente o bloco abaixo para implementar a funcionalidade)
			/*
			case 6:
			...
			*/
			...
			// --- MELHORIA 5: adicionar novo case ---
			// (descomente o bloco abaixo para implementar a funcionalidade)
			/*
			case 7:
		...
		// --- MELHORIAS 3, 4 E 5: ATUALIZAR ESTE IF ---
		...
		// (e o 'escolha != 3' deve ser mudado para 'escolha != 3 && escolha != 5 && escolha != 6 && escolha != 7')
